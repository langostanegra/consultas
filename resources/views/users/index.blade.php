        ...
        <div class="card card-nav-tabs text-left">
            ...
            <div class="card-body">
                <div class="col-12 text-right">
                    <button type="button" class="btn btn-sm btn-primary boton_anadir_usuario">{{ __('Añadir usuario') }}</button>
                </div>
...
<div class="modal fade" id="modal_editar_usuario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button id="btn_editar_usuario" type="button" class="btn btn-primary">Añadir</button>
            </div>
        </div>
    </div>
</div>
